...
\vspace{-2em}
  \begin{columns}
    \column{0.5\textwidth}
      \centering 
      Males \\ \vspace{.5em}
      \only<1>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Mtr1.pdf}}
      \only<2>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Mtr2.pdf}}
      \only<3>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Mtr3.pdf}}
    \column{0.5\textwidth}
    \centering
      Females \\ \vspace{.5em}
      \only<1>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Ftr1.pdf}}
      \only<2>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Ftr2.pdf}}
      \only<3>{\includegraphics[height=1.1\textheight,keepaspectratio]{Figures/Ftr3.pdf}}
  \end{columns}
  \end{overlayarea}
